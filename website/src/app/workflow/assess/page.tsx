...
/**
 * /workflow/assess — Placeholder for assess stage workflows.
 */

import Link from 'next/link';
import ScrollReveal from '@/components/home/ScrollReveal';

export default function AssessWorkflowPage() {
  const workflows = [
    ...
    <main data-surface="tkg" className="min-h-screen bg-[var(--paper)]">
        ...
        <div className="rail-default">
          ...
          <ScrollReveal delay={300}>
            <div className="prose-rail mt-6">
              ...
              >
                Exposure scenario builder and dose calculator. Coming soon.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal delay={450}>
            <div className="mt-10 flex justify-center">
              ...
              >
                <source src="/icons/stage-assess.mp4" type="video/mp4" />
              </video>
            </div>
          </ScrollReveal>
        </div>
      ...
      <section className="bg-[var(--paper-warm)] py-20">
        <div className="rail-default">
          ...
          >
            These workflows are under development. Check back soon for interactive tools to assess exposure scenarios and calculate dose risk.
          </p>
        </div>
      </section>
